...
export default function NotaPromissoria({ informacoes } : InformacoesProps  ) {
  ...
  const generatePdf = async () => {
    ...
    const valor = numeroPorExtenso(informacoes.valor_receber).toUpperCase();
    const valorAjustado = doc.splitTextToSize(
      `${valor} EM MOEDA CORRENTE DESTE PAÍS`, 
      105
    );

    doc.setFillColor(255,255,255);
    doc.rect(72, 41, 130, 10, "F");
